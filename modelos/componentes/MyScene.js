...
import { C_tornillos } from './C_tornillos.js';
import { C_placa } from './C_placa.js';
...
class MyScene extends THREE.Scene {
  ...
  constructor (myCanvas) { 
    ...
    this.tornilos = new C_tornillos(this.gui, 'Controles Tornillos');
    this.add(this.tornilos);

    this.placa = new C_placa(this.gui, 'Controles Placa');
    this.add(this.placa);
